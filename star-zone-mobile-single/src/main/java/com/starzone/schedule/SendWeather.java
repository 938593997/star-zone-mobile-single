...
//				Map<String, Object> weatherInfo = restTmpl.getForEntity("http://star-zone-mobile-common/weather/getWeatherByCityName?cityName={1}", Map.class, user.getExt1()).getBody();
				Map<String, Object> weatherInfo = this.getWeatherByCityName(user.getExt1());
	 ...
	 * @author qiu_hf
	 * @history 2019年11月3日 上午11:33:46 Create by 【qiu_hf】
	 */
	private Map<String, Object> getWeatherByCityName(String cityName) throws ServiceException, RemoteException {
...
//		return today.append("\r\n").append(tomorrow).append("\r\n").append(theDayAfterTomorrow).toString();
	    return map;
	}
