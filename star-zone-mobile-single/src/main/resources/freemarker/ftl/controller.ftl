...
public class ${entityName}Controller {
	 ...
	 * @time    ${createTime}
	 */
	@GetMapping("/get${entityName}ById")
	...
	public JsonResult<${entityName}> get${entityName}ById(${idType} id){
	...
	public JsonResult<${entityName}> insert${entityName}(@RequestBody ${entityName} ${objectName}){
		JsonResult<${entityName}> result = new JsonResult<${entityName}>();
		try {
	 ...
	 * @time    ${createTime}
	 */
	@DeleteMapping("/delete${entityName}ByPrimaryKey")
	...
	public JsonResult<Object> delete${entityName}ByPrimaryKey(${idType} id){
	...
	@PutMapping("/update${entityName}ByPrimaryKey")
	public JsonResult<${entityName}> update${entityName}ByPrimaryKey(@RequestBody ${entityName} ${objectName}){
		JsonResult<${entityName}> result = new JsonResult<${entityName}>();
		try {
	 ...
	 * @time    ${createTime}
	 */
	@GetMapping("/get${entityName}Page")
	...
	public JsonResult<PageInfo<${entityName}>> get${entityName}Page(Integer pageNum, Integer pageSize, ${entityName} ${objectName}){
